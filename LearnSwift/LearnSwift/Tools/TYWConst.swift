...
/// 第一次启动
let TYWFirstLuanch = "firstLaunch"
/// 是否登录
let isLogin = "isLogin"
...
/// RGBA的颜色设置
func TYWColor(r:CGFloat, g:CGFloat, b:CGFloat, a:CGFloat) -> UIColor {
    return UIColor(red: r / 255.0, green: g / 255.0, blue: b / 255.0, alpha: a)
}

/// 背景灰色
func TYWlobalColor() -> UIColor {
    return TYWColor(r: 240, g: 240, b: 240, a: 1)
}

/// 红色
func TYWlobalRedColor() -> UIColor {
    return TYWColor(r: 245, g: 80, b: 83, a: 1.0)
}
